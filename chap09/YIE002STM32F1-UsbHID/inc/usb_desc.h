...
#define CUSTOMHID_SIZ_STRING_VENDOR             12   //unicode string: 'Robin'//38
#define CUSTOMHID_SIZ_STRING_PRODUCT            44   //unucode string:Robin's UEFI Explorer//32
#define CUSTOMHID_SIZ_STRING_SERIAL             12   //26
